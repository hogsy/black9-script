...
// Localization
var() localized string Font10;
var() localized string Font20;
var() localized string Font30;
var() localized string Font10B;
var() localized string Font20B;
var() localized string Font30B;
// End Modification
/////////////////////////
...
// Localization
	if(GUIScale == 2)
	{
		Fonts[F_Normal] = Font(DynamicLoadObject(Font20, class'Font'));
		Fonts[F_Bold] = Font(DynamicLoadObject(Font20B, class'Font'));
		Fonts[F_Large] = Font(DynamicLoadObject(Font30, class'Font'));
		Fonts[F_LargeBold] = Font(DynamicLoadObject(Font30B, class'Font'));
	}
	else
	{
 		Fonts[F_Normal] = Font(DynamicLoadObject(Font10, class'Font'));
 		Fonts[F_Bold] = Font(DynamicLoadObject(Font10B, class'Font'));
 		Fonts[F_Large] = Font(DynamicLoadObject(Font20, class'Font'));
 		Fonts[F_LargeBold] = Font(DynamicLoadObject(Font20B, class'Font'));
	}	
// End Modification
/////////////////////////
}
...
defaultproperties
{
	...
	bAllowConsole=true
	MouseScale=0.6
	Font10="UWindowFonts.Tahoma10"
	Font20="UWindowFonts.Tahoma20"
	Font30="UWindowFonts.Tahoma30"
	Font10B="UWindowFonts.TahomaB10"
	Font20B="UWindowFonts.TahomaB20"
	Font30B="UWindowFonts.TahomaB30"
