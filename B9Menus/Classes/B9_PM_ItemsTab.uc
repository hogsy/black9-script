...
class B9_PM_ItemsTab extends B9_PM_SharedTop;

var private texture fTabLeftTex;
var private texture fTabMiddleTex;
var private texture fTabRightActiveTex;
...
function PostRender( canvas Canvas )
{
	...
	Canvas.DrawTile( fTabRightActiveTex, 128, 32, 0, 0, 128, 32 );
...
defaultproperties
{
	...
	fTabRightActiveTex=TexScaler'B9Menu_textures.Quarter_Size_Panes.tab_right_active'
