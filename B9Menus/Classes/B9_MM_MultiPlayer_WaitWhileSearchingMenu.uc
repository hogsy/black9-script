/////////////////////////////////////////////////////////////
// B9_MM_MultiPlayer_WaitWhileSearchingMenu
//
// 
// 
// This is CURRENTLY a debug menu.

class B9_MM_MultiPlayer_WaitWhileSearchingMenu extends B9_MM_SimpleListMenu;

var B9MP_ServerBrowser fServerBrowser;

var localized string fPleaseWaitLabel;
var localized string fSearchFailureLabel;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		fServerBrowser.fLAN = B9_MMInteraction( parent ).fLAN;

		if ( B9_MMInteraction( parent ).fLAN )
			Log( "KMY: Wait Menu asking for LAN servers" );
		else
...
function RefreshMenus()
{
	...
	if ( ! fServerBrowser.fServersDirty )
	{
		...
		{
			fItemArray[ 0 ].Label = fSearchFailureLabel;		// fServerBrowser.fErrorMessage
		}
		else
		{
...
defaultproperties
{
	...
	fSearchFailureLabel="Server search failed"
}