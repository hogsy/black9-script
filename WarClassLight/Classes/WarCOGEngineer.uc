class WarCOGEngineer extends CogLightInfantry;
...
defaultproperties
{
	Helmet=StaticMesh'character_helmetmeshes.cog_helmets.COGEnginerHelmet1'
	LandGrunt=Sound'MaleSounds.(All).land10'
	ClassIcon=Texture'SG_Hud.COG.sg_classicons_engineer'
	LoadOut=0
