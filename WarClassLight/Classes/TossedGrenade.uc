...
// Grenade.
//=============================================================================
class TossedGrenade extends Projectile;

#EXEC OBJ LOAD FILE=..\StaticMeshes\COGAssaultRifle.usx PACKAGE=COGAssaultRifle
...
defaultproperties
{
	...
	MyDamageType=Class'WarDamageExplosion'
	ImpactSound=Sound'WarEffects.EightBall.GrenadeFloor'
	ExplosionDecal=Class'BlastMark'
	Physics=2
	DrawType=8
	StaticMesh=StaticMesh'COGAssaultRifle.1stPerson.CogAssGrenade'
	DrawScale=0.25
	AmbientGlow=64
	bBounce=true
}