// ====================================================================
//  Class:  WarClassLight.AttachmentCOGMedicGun
//
...
class AttachmentCOGMedicGun extends WarfareWeaponAttachment;
...
simulated function SpawnEffect()
{
	local vector Start;
	local rotator Rot;
	local PclCOGHealRay Effect;

	GetEffectStart(Start,Rot);
	
	Effect = spawn(class'PclCOGHealRay',Instigator,,Start,Rot );
...
simulated event ThirdPersonEffects()
{
	...
	if (bAutoFire)
	{
		...
		{
			AmbientSound = sound'WeaponSounds.CogMedicGun.medgun_shoot';
		}
	}
	else
	{
