/////////////////////////////////////////////////////////////
// B9_SkillRockTechKiosk
//

class B9_SkillRockTechKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillRockTechKioskStock);
	}
}

defaultproperties
{
	fStrCategoryName="GEOMANCY"
	TriggerTagName=SkillRockTechKioskTrigger
}