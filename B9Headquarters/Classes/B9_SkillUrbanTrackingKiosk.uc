/////////////////////////////////////////////////////////////
// B9_SkillUrbanTrackingKiosk
//

class B9_SkillUrbanTrackingKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillUrbanTrackingKioskStock);
	}
}
...
{
	fHulaColor=2
	fStrCategoryName="SURVEILLANCE"
	TriggerTagName=SkillUrbanTrackingKioskTrigger
}