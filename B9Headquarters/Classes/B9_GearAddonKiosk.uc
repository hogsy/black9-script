...
class B9_GearAddonKiosk extends B9_BuyPhysicalKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockItems(Listener.intermission.AddonGearKioskStock);
	}
}
...
defaultproperties
{
	...
	fStrCategoryName="ADD-ONS"
	TriggerTagName=GearAddonKioskTrigger
}