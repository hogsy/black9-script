/////////////////////////////////////////////////////////////
// B9_SkillFireTechKiosk
//

class B9_SkillFireTechKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillFireTechKioskStock);
	}
}

defaultproperties
{
	fStrCategoryName="PYROMANCY"
	TriggerTagName=SkillFireTechKioskTrigger
}