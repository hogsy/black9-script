///////////////////////
//
// B9_BioCalibrationChamber.uc

class B9_BioCalibrationChamber extends B9_BaseKiosk;
...
var localized string fStrNoRequestedChanges;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	if (RootInteraction == self)
	{
		...
		fStrNoRequestedChanges = "<font size=\"24\">" $ fStrNoRequestedChanges $ "</font><br/>";
		...
		{
			DescriptionBody[0] = fStrNoRequestedChanges;
		}
		else
		{
...
defaultproperties
{
	fStrConfirmMsg="Are you sure you want to apply these changes?"
	fStrChamberName="BIO-CALIBRATION CHAMBER"
	fStrNoRequestedChanges="There are no requested changes indicated."
	fStrRequestMods="Requested Calibrations:"
	...
	TriggerTagName=BioCalibrationChamberTrigger
