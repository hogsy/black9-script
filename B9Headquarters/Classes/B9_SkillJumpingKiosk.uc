/////////////////////////////////////////////////////////////
// B9_SkillJumpingKiosk
//

class B9_SkillJumpingKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillJumpingKioskStock);
	}
}
...
{
	fHulaColor=2
	fStrCategoryName="PHYSICAL"
	TriggerTagName=SkillJumpingKioskTrigger
}