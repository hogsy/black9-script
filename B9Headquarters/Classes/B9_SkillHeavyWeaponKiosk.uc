/////////////////////////////////////////////////////////////
// B9_SkillHeavyWeaponKiosk
//

class B9_SkillHeavyWeaponKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillHeavyWeaponKioskStock);
	}
}
...
defaultproperties
{
	...
	TriggerTagName=SkillHeavyWeaponKioskTrigger
}