/////////////////////////////////////////////////////////////
// B9_WeaponExplosivesKiosk
//

class B9_WeaponExplosivesKiosk extends B9_BuyPhysicalKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockItems(Listener.intermission.ExplosivesKioskStock);
	}
}
...
defaultproperties
{
	...
	fIsWeaponKiosk=true
	fStrCategoryName="EXPLOSIVES"
	TriggerTagName=WeaponExplosivesKioskTrigger
}