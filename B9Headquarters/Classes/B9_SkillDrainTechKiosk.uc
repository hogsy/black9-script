/////////////////////////////////////////////////////////////
// B9_SkillDrainTechKiosk
//

class B9_SkillDrainTechKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillDrainTechKioskStock);
	}
}

defaultproperties
{
	fStrCategoryName="NECROMANCY"
	TriggerTagName=SkillDrainTechKioskTrigger
}