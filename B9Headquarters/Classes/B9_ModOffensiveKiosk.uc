/////////////////////////////////////////////////////////////
// B9_ModOffensiveKiosk
//

class B9_ModOffensiveKiosk extends B9_BuyModKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.OffensiveModKioskStock);
	}
}

defaultproperties
{
	fStrCategoryName="OFFENSIVE"
	TriggerTagName=ModOffensiveKioskTrigger
}