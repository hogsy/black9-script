/////////////////////////////////////////////////////////////
// B9_SkillWaterTechKiosk
//

class B9_SkillWaterTechKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillWaterTechKioskStock);
	}
}

defaultproperties
{
	fStrCategoryName="HYDROMANCY"
	TriggerTagName=SkillWaterTechKioskTrigger
}