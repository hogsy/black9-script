/////////////////////////////////////////////////////////////
// B9_ModDefensiveKiosk
//

class B9_ModDefensiveKiosk extends B9_BuyModKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.DefensiveModKioskStock);
	}
}

defaultproperties
{
	fStrCategoryName="DEFENSIVE"
	TriggerTagName=ModDefensiveKioskTrigger
}