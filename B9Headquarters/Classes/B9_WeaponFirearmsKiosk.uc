/////////////////////////////////////////////////////////////
// B9_WeaponFirearmKiosk
//

class B9_WeaponFirearmsKiosk extends B9_BuyPhysicalKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		//log("Listener is"$Listener$":Intermission"$Listener.intermission);//$"FirearmsKioskStock."$Listener.intermission.FirearmsKioskStock);
		StockItems(Listener.intermission.FirearmsKioskStock);
	}
}
...
defaultproperties
{
	...
	fIsWeaponKiosk=true
	fStrCategoryName="FIREARMS"
	TriggerTagName=WeaponFirearmsKioskTrigger
}