/////////////////////////////////////////////////////////////
// B9_SkillMindOverBodyKiosk
//

class B9_SkillMindOverBodyKiosk extends B9_ManageSkillKiosk;
...
function MenuInit(B9_MenuInteraction interaction, PlayerController controller, B9_MenuInteraction parent)
{
	...
	{
		StockMods(Listener.intermission.SkillMindOverBodyKioskStock);
	}
}

defaultproperties
{
	fStrCategoryName="MIND & BODY"
	TriggerTagName=SkillMindOverBodyKioskTrigger
}