...
////////////////////////////////////////////
// SB, Taldren, 4/14/03
// Adding Force Feedback support fo XBox
//
var() globalconfig	bool bUseForceFeedback;
//
// End Changes
///////////////////////////
...
replication
{
	...
	reliable if( Role<ROLE_Authority )
		UpdateForceFeedbackProperties;

	reliable if( Role==ROLE_Authority )
		RequestForceFeedbackProperties;

	reliable if( bNetDirty && bNetOwner && Role==ROLE_Authority )
		bUseForceFeedback, bForceFeedbackSupported;
	//
	// End Changes
	///////////////////////////
}
...
// SB, Taldren, Added 1/24/03
native function SetVisionMode( EVisionMode mode );
...
// Savepoint support, JP/Taldren 2/17/03
native final function SavepointLevel(optional Actor RespawnPoint);
...
// SB, Taldren, 4/14/03
// Adding Force Feedback support fo XBox
function UpdateForceFeedbackProperties( bool bSupported, bool bUse )
{
	bForceFeedbackSupported = bSupported && bUse;
	bUseForceFeedback		= bUse;
}
...
simulated function RequestForceFeedbackProperties()
{
	...
	{
		UpdateForceFeedbackProperties( ForceFeedbackSupported(), bUseForceFeedback );
	}
}
...
{
	if( MyHUD == None )
		ClientSetHUD( newHUDClass );	// Modified:  Sean C. Dumas/Taldren
}
