...
//-----------------------------------------------------------------------------
// Black 9 Overhead Map Properties

var(Overhead_Map) float fOverheadMap_OffsetX;
var(Overhead_Map) float fOverheadMap_OffsetY;
var(Overhead_Map) float fOverheadMap_ScaleX;
var(Overhead_Map) float fOverheadMap_ScaleY;

var(Overhead_Map) texture fOverheadMap_Texture;
...
defaultproperties
{
	...
	DistanceFogColor=(B=128,G=128,R=128,A=0)
	DistanceFogStart=3000
	DistanceFogEnd=8000
	DistanceFogBlendTime=1
	TexUPanSpeed=1
	TexVPanSpeed=1
	fOverheadMap_ScaleX=1
	fOverheadMap_ScaleY=1
	bStatic=true
	bNoDelete=true
