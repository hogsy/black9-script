...
// SB, Taldren, Added 3/12/03
//
var bool	fContinuous;
...
function bool CanAttack(Actor Other)
{
	...
	if ( (HitActor == None) || (HitActor == Other) ||
		((Pawn(HitActor) != None) && !Instigator.Controller.SameTeamAs(Pawn(HitActor).Controller)) )
		return true;
...
defaultproperties
{
	...
	ShakeMag=300
	shaketime=0.1
	ShakeVert=(X=0,Y=0,Z=5)
	ShakeSpeed=(X=100,Y=100,Z=100)
	aimerror=550
	AIRating=0.5
	CurrentRating=0.5
	TraceDist=10000
