...
// 
//
native function StoreCharacterData( String name, String characterData );
native function RestoreFromTravelInfo( String name, PlayerController playerToRestore );
//
// KMY, end changes
//////////////////////
...
//
 	if(IsFromDeath)
  	{
  		ApplyTravelInfo( aPlayer.Pawn, aPlayer.PlayerReplicationInfo.PlayerName );
  	}
  	else
  	{
...
//////////////////////
	...
	if ( !bDelayedStart )
	{
		...
		{
			// Fix from UDN (Joe Pearce/Taldren)
			if ( NewPlayer.IsA('PlayerController') && (NewPlayer.Pawn == None) )
			{
///////////////////////////////////
// XT,Taldren, 5/27/03
// 
				RestartPlayer(NewPlayer, false);
//
// XT, end changes
//////////////////////
			}
...
//
	if ( Viewport( NewPlayer.Player ) != None )
		NewPlayer.bIsLocallyControlled = true;
//
// KMY, end changes
//////////////////////
}
