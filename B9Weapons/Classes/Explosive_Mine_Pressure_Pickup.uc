class Explosive_Mine_Pressure_Pickup extends B9_AccumulativeItemPickup
	placeable;
...
defaultproperties
{
	Amount=5
	fIniLookupName="Mine"
	InventoryType=Class'Explosive_Mine_Pressure'
	PickupMessage="Acquired Anti-personnel Mine."
