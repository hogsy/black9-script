class Explosive_Mine_Trip_Pickup extends B9_AccumulativeItemPickup
	placeable;
...
defaultproperties
{
	...
	InventoryType=Class'Explosive_Mine_Trip'
	PickupMessage="Acquired Anti-personnel Trip Mine."
