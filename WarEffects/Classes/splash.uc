...
#exec MESH IMPORT MESH=WaterImpactM ANIVFILE=..\botpack\MODELS\splash_a.3D DATAFILE=..\botpack\MODELS\splash_d.3D X=0 Y=0 Z=0
...
#exec TEXTURE IMPORT NAME=Asplash1 FILE=..\botpack\MODELS\splash.PCX GROUP="Skins" MASKED=1
