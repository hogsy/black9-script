...
#exec MESH IMPORT MESH=ChipM ANIVFILE=..\botpack\MODELS\chip_a.3D DATAFILE=..\botpack\MODELS\chip_d.3D X=0 Y=0 Z=0
...
#exec TEXTURE IMPORT NAME=Chip1 FILE=..\botpack\MODELS\chip.PCX GROUP=Skins
